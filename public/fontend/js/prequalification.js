(function ($) {
  ...
  $(document).ready(function () {
    ...
    $.ajax({
      type: "GET",
      url: base_url + "user/prequalification/get_category",
    ...
    $.ajax({
      type: "GET",
      url: base_url + "user/prequalification/get_type",
      data: { id: $(this).val(), csrf_token_name: csrf_token },
      beforeSend: function () {
    ...
    $.ajax({
      type: "GET",
      url: base_url + "user/prequalification/get_method",
      data: { id: $(this).val(), csrf_token_name: csrf_token },
      beforeSend: function () {
    ...
    $.ajax({
      type: "GET",
      url: base_url + "user/prequalification/get_organisation",
      data: { id: $(this).val(), csrf_token_name: csrf_token },
      beforeSend: function () {
    ...
    $("#organisation").change(function () {
      ...
      $.ajax({
        type: "POST",
        url: base_url + "user/prequalification/get_entity",
        data: { id: $(this).val(), csrf_token_name: csrf_token },
        beforeSend: function () {
      ...
      .bootstrapValidator({
        fields: {
          prequalification_title: {
            validators: {
              notEmpty: {
                message: "Please Enter prequalification_title",
              },
            },
          },
          category: {
          ...
          prequalification_location: {
            validators: {
              notEmpty: {
                message: "Please Enter prequalification location...",
              },
            },
          },
          prequalifcations_amount: {
            validators: {
              digits: {
                message:
                  "Please Enter valid prequalification amount and not user in special characters...",
              },
              notEmpty: {
                message: "Please Enter prequalification amount...",
              },
            },
          },
          prequalifcations_amount: {
          ...
          basic_amount: {
            validators: {
              digits: {
                message:
                  "Please Enter valid prequalication amount and not user in special characters...",
              },
              notEmpty: {
                message: "Please Enter prequalication amount...",
              },
            },
          },
          Enterprise_amount: {
  ...
  function initialize() {
    ...
    autocomplete = new google.maps.places.Autocomplete(
      ...
      (document.getElementById("prequalification_location")),
      {
        types: ["geocode"],
      }
    );
    ...
    $.get(
      ...
      function (data, status) {
        $(data.results).each(function (key, value) {
          $("#sprequalification_address").val(place.formatted_address);
          $("#sprequalification_latitude").val(value.geometry.location.lat);
          $("#sprequalification_longitude").val(value.geometry.location.lng);
        });
      }
    );
  }
  ...
  if ($("#add, #update_prequalification").length > 0) {
