                                                ...
                                                <fieldset class="form-group">
                                                 ...
                                                 <strong>{{ $message }}</strong>
                                                   ...
                                                   @enderror
                                                    ...
                                                    <a href="{{ route('register') }}" class="btn btn-outline-success float-left btn-inline">Register</a>
                                                    <button type="submit" class="btn btn-login float-right btn-inline">Login</button>
                                                </form>
                                            </div>
                                        </div>
